...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_literalTypes = 40,              /* literalTypes  */
  YYSYMBOL_identifier = 41,                /* identifier  */
  YYSYMBOL_globalVar = 42,                 /* globalVar  */
  YYSYMBOL_multoArray = 43,                /* multoArray  */
  YYSYMBOL_multoArrayList = 44,            /* multoArrayList  */
  ...
  YYSYMBOL_commandList = 51,               /* commandList  */
  YYSYMBOL_commandBlock = 52,              /* commandBlock  */
  YYSYMBOL_localVariable = 53,             /* localVariable  */
  YYSYMBOL_localVariableList = 54,         /* localVariableList  */
...
{
       0,    46,    46,    48,    50,    50,    50,    50,    51,    51,
      51,    51,    51,    53,    55,    56,    56,    57,    57,    58,
      58,    60,    61,    62,    62,    63,    63,    66,    74,    74,
      75,    78,    79,    81,    81,    82
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_ERRO", "';'", "'['", "']'", "'^'", "','", "'('", "')'", "'{'", "'}'",
  "$accept", "program", "types", "literalTypes", "identifier", "globalVar",
  "multoArray", "multoArrayList", "varList", "function", "functionHeader",
  "parameter", "parameterList", "command", "commandList", "commandBlock",
  "localVariable", "localVariableList", "variableDeclaration", YY_NULLPTR
};
...
{
      18,   -25,   -25,   -25,   -25,     6,   -19,    18,   -25,   -25,
     -20,   -19,     4,   -25,   -16,    18,    -7,   -25,   -24,    18,
     -25,    18,   -25,    -4,   -25,   -19,   -19,    -3,   -19,    18,
      -2,     2,   -25,    10,   -20,   -25,    18,    -1,    17,     3,
     -25,   -25,   -25,   -25,   -25,   -19,   -25,    -9,   -19,   -25,
      -3,   -25,   -25,   -25,   -25,   -25,   -25,     3,   -25,   -25
};
...
{
       3,     4,     5,     6,     7,     0,     0,     3,     1,    13,
      16,     0,     0,    20,     0,     3,     0,    18,     0,    24,
       2,    29,    21,     0,    14,     0,     0,    26,     0,    29,
       0,     0,    15,     0,    16,    23,     0,     0,    31,    34,
      28,    30,    27,    17,    19,     0,    22,     0,     0,    35,
      26,     8,     9,    10,    11,    12,    32,    34,    25,    33
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -25,    -5,   -18,   -25,    -6,   -25,     7,   -25,   -25,   -25,
     -25,   -25,   -14,   -25,     8,   -25,   -10,   -17,   -25
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     5,     6,    56,    38,     7,    13,    23,    18,    15,
      16,    27,    37,    29,    30,    22,    39,    49,    31
};
...
{
      10,    26,    11,    28,    24,    14,     8,     9,    25,    12,
      20,    28,    51,    52,    53,    54,    55,    19,    45,    34,
      35,     1,     2,     3,     4,    17,    32,    33,    21,    36,
      42,    43,    47,    46,    41,    48,    58,    40,    57,    50,
      59,    44
};

static const yytype_int8 yycheck[] =
{
       6,    19,     7,    21,    28,    11,     0,    26,    32,    29,
      15,    29,    21,    22,    23,    24,    25,    33,    36,    25,
      26,     3,     4,     5,     6,    21,    30,    31,    35,    32,
      28,    21,    15,    34,    36,    32,    50,    29,    48,    45,
      57,    34
};
...
{
       0,     3,     4,     5,     6,    38,    39,    42,     0,    26,
      41,    38,    29,    43,    41,    46,    47,    21,    45,    33,
      38,    35,    52,    44,    28,    32,    39,    48,    39,    50,
      51,    55,    30,    31,    41,    41,    32,    49,    41,    53,
      51,    36,    28,    21,    43,    39,    34,    15,    32,    54,
      41,    21,    22,    23,    24,    25,    40,    53,    49,    54
};
